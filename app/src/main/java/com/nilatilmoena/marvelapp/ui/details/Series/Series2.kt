...
class Series2 : AppCompatActivity(), View.OnClickListener {
    ...
    lateinit var ivSerResponseDet2 : ImageView
    private val evImgDet2 = "https://i.annihil.us/u/prod/marvel/i/mg/9/20/5f4037d30efa5/standard_fantastic.jpg"
    lateinit var tvSerResponseSerName2 : TextView
    lateinit var tvSerResponseSerDesc2 : TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ivSerResponseDet2 = findViewById(R.id.ivSerDet2)
        tvSerResponseSerName2 = findViewById(R.id.tvSerName2)
        tvSerResponseSerDesc2 = findViewById(R.id.tvSerDesc2)
        ...
        Glide.with(this)
            .load(evImgDet2)
            .fitCenter()
            .into(ivSerResponseDet2)
    }

    override fun onClick(v: View) {
        when(v.id){
            R.id.btnBackSerDetail -> {
                val intentBackDetail = Intent(this@Series2, SeriesActivity::class.java)
        ...
        call.enqueue(object: Callback<Series> {
            override fun onResponse(call: Call<Series>, response: Response<Series>) {
                if (response.body() != null) {
                    tvSerResponseSerName2.text = response.body()!!.data.results[15].title
                    tvSerResponseSerDesc2.text = response.body()!!.data.results[15].description
                    tvSerResponseAttribution.text = response.body()!!.attributionText
                }
            }

            override fun onFailure(call: Call<Series>, t: Throwable) {
                tvSerResponseSerName2.setText("Error occured: " + t)
            }
