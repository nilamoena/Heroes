...
class Event17 : AppCompatActivity(), View.OnClickListener {
    ...
    lateinit var ivEvResponseDet17 : ImageView
    private val evImgDet17 = "https://i.annihil.us/u/prod/marvel/i/mg/3/c0/56d082ff38722/standard_fantastic.jpg"
    lateinit var tvEvResponseEvName17 : TextView
    lateinit var tvEvResponseEvDesc17 : TextView
    lateinit var tvEvResponseAttribution : TextView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_event17)

        ivIntentBackDetail = findViewById(R.id.btnBackEvDetail)
        ivIntentBackDetail.setOnClickListener(this)

        ivEvResponseDet17 = findViewById(R.id.ivEvDet17)
        tvEvResponseEvName17 = findViewById(R.id.tvEvName17)
        tvEvResponseEvDesc17 = findViewById(R.id.tvEvDesc17)
        ...
        Glide.with(this)
            .load(evImgDet17)
            .fitCenter()
            .into(ivEvResponseDet17)
    }

    override fun onClick(v: View) {
        when(v.id){
            R.id.btnBackEvDetail -> {
                val intentBackDetail = Intent(this@Event17, EventsActivity::class.java)
        ...
        call.enqueue(object: Callback<Events> {
            override fun onResponse(call: Call<Events>, response: Response<Events>) {
                if (response.body() != null) {
                    tvEvResponseEvName17.text = response.body()!!.data.results[16].title
                    tvEvResponseEvDesc17.text = response.body()!!.data.results[16].description
                    tvEvResponseAttribution.text = response.body()!!.attributionText
                }
            }

            override fun onFailure(call: Call<Events>, t: Throwable) {
                tvEvResponseEvName17.setText("Error occured: " + t)
            }
